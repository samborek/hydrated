...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I9unp6s7p7qb3c>, false, never>;
        /**
    ...
    TechnicalCommittee: {
         ...
         */
        ProposalOf: StorageDescriptor<[Key: FixedSizeBinary<32>], Anonymize<I4q2j8sno9uqjo>, true, never>;
        /**
    ...
    Dispatcher: {
         ...
         */
        LastEvmCallExitReason: StorageDescriptor<[], Anonymize<Iag9iovb9j5ijo>, true, never>;
    };
    AssetRegistry: {
        /**
         * Details of an asset.
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ia4s0s7tqu8213>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Icvshck4gqsdb3>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ia4s0s7tqu8213>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I2aps8j319mlbr>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ia4s0s7tqu8213>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Ibhp2dqigngj06>>;
    };
    Preimage: {
        /**
    ...
    TechnicalCommittee: {
         ...
         */
        execute: TxDescriptor<Anonymize<I3e01ufekm2iv0>>;
        /**
         ...
         */
        propose: TxDescriptor<Anonymize<Idchc3og7q70q2>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I3krsd68voge2c>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Ib430kblaqlnpv>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I5mm39gh6jt03e>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ierm4cuff0nc1v>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I36m0f7qe1s9ga>>;
    };
    Dispatcher: {
        /**
        
         */
        dispatch_as_treasury: TxDescriptor<Anonymize<I36m0f7qe1s9ga>>;
        /**
        
         */
        dispatch_as_aave_manager: TxDescriptor<Anonymize<I36m0f7qe1s9ga>>;
        /**
         ...
         */
        dispatch_with_extra_gas: TxDescriptor<Anonymize<I40fsssog35248>>;
        /**
         ...
         */
        dispatch_evm_call: TxDescriptor<Anonymize<I36m0f7qe1s9ga>>;
    };
    AssetRegistry: {
        /**
    ...
    HSM: {
         ...
         * - Other errors from underlying calls
         */
        execute_arbitrage: TxDescriptor<Anonymize<I7m9urt7tq9546>>;
        /**
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I3herj6pe488a7>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I85ri4bb7csdff>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<Ife14aghvh48kt>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I38g5069ai5208>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Ib49aqspg5hstj>>;
        /**
         * `:code` was updated.
         */
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I3n32bkfrn0fem>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I1dovot8nbveko>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I7jp796vos0h7r>>;
    };
    Preimage: {
        /**
    ...
    TechnicalCommittee: {
         ...
         */
        Executed: PlainDescriptor<Anonymize<I30mpt6d2425ol>>;
        /**
         * A single member did some action; result will be `Ok` if it returned without error.
         */
        MemberExecuted: PlainDescriptor<Anonymize<I30mpt6d2425ol>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I7jp796vos0h7r>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Ifgl7hqp4kv2c0>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I1h36qi63fa0q1>>;
    };
    Dispatcher: {
        /**
        
         */
        TreasuryManagerCallDispatched: PlainDescriptor<Anonymize<I1h36qi63fa0q1>>;
        /**
        
         */
        AaveManagerCallDispatched: PlainDescriptor<Anonymize<I1h36qi63fa0q1>>;
    };
    AssetRegistry: {
        /**
    ...
    HSM: {
         ...
         */
        CollateralRemoved: PlainDescriptor<Anonymize<Ia5le7udkgbaq9>>;
        /**
         ...
         */
        ArbitrageExecuted: PlainDescriptor<Anonymize<I1dk1vms6l4mpg>>;
        /**
    ...
    DCA: {
         ...
         */
        TradeFailed: PlainDescriptor<Anonymize<I969a7skbb7nq7>>;
        /**
         * The DCA is terminated and completely removed from the chain
         */
        Terminated: PlainDescriptor<Anonymize<I969a7skbb7nq7>>;
        /**
         ...
         */
        RandomnessGenerationFailed: PlainDescriptor<Anonymize<I13s0t6foeiprk>>;
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Iceqrmm2tkkbsu>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I1gk5vej1stbl>>;
        /**
    ...
    EthereumRuntimeRPCApi: {
         ...
         */
        call: RuntimeDescriptor<[from: FixedSizeBinary<20>, to: FixedSizeBinary<20>, data: Binary, value: Anonymize<I4totqt881mlti>, gas_limit: Anonymize<I4totqt881mlti>, max_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, max_priority_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, nonce: Anonymize<Ic4rgfgksgmm3e>, estimate: boolean, access_list: Anonymize<I3dj14b7k3rkm5>], Anonymize<Idnmlh360odg5f>>;
        /**
        
         */
        create: RuntimeDescriptor<[from: FixedSizeBinary<20>, data: Binary, value: Anonymize<I4totqt881mlti>, gas_limit: Anonymize<I4totqt881mlti>, max_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, max_priority_fee_per_gas: Anonymize<Ic4rgfgksgmm3e>, nonce: Anonymize<Ic4rgfgksgmm3e>, estimate: boolean, access_list: Anonymize<I3dj14b7k3rkm5>], Anonymize<I5f8qfa5ua9hqb>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<Iathhdqc4u75dj>, call: Anonymize<I4q2j8sno9uqjo>], Anonymize<Is2kt34b7nq11>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I4oghpbqve1jg6>>;
    };
    /**
...
export type HydrationDispatchError = Anonymize<Iakh3t43lk746d>;
...
export type HydrationCallData = Anonymize<I4q2j8sno9uqjo> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    storage: {
        ...
        TechnicalCommittee: ['Proposals', 'ProposalOf', 'Voting', 'ProposalCount', 'Members', 'Prime'];
        ...
        Duster: ['AccountBlacklist', 'RewardAccount', 'DustAccount'];
        ...
        CircuitBreaker: ['TradeVolumeLimitPerAsset', 'AllowedTradeVolumeLimitPerAsset', 'LiquidityAddLimitPerAsset', 'AllowedAddLiquidityAmountPerAsset', 'AssetLockdownState', 'LiquidityRemoveLimitPerAsset', 'AllowedRemoveLiquidityAmountPerAsset'];
        Router: ['Routes'];
        ...
        EVM: ['AccountCodes', 'AccountCodesMetadata', 'AccountStorages', 'Suicided'];
        EVMChainId: ['ChainId'];
        Ethereum: ['Pending', 'CounterForPending', 'CurrentBlock', 'CurrentReceipts', 'CurrentTransactionStatuses', 'BlockHash'];
        EVMAccounts: ['AccountExtension', 'ContractDeployer', 'ApprovedContract'];
        DynamicEvmFee: ['BaseFeePerGas'];
        XYKWarehouseLM: ['FarmSequencer', 'DepositSequencer', 'GlobalFarm', 'YieldFarm', 'Deposit', 'ActiveYieldFarm'];
        DCA: ['ScheduleIdSequencer', 'Schedules', 'ScheduleOwnership', 'RemainingAmounts', 'RetriesOnError', 'ScheduleExecutionBlock', 'ScheduleIdsPerBlock'];
        ...
        PolkadotXcm: ['QueryCounter', 'Queries', 'AssetTraps', 'SafeXcmVersion', 'SupportedVersion', 'VersionNotifiers', 'VersionNotifyTargets', 'VersionDiscoveryQueue', 'CurrentMigration', 'RemoteLockedFungibles', 'LockedFungibles', 'XcmExecutionSuspended', 'ShouldRecordXcm', 'RecordedXcm'];
    ...
    tx: {
        ...
        TechnicalCommittee: ['set_members', 'execute', 'propose', 'vote', 'disapprove_proposal', 'close'];
        ...
        Duster: ['dust_account', 'add_nondustable_account', 'remove_nondustable_account'];
        ...
        CircuitBreaker: ['set_trade_volume_limit', 'set_add_liquidity_limit', 'set_remove_liquidity_limit', 'lockdown_asset', 'force_lift_lockdown', 'release_deposit'];
    ...
    events: {
        ...
        TechnicalCommittee: ['Proposed', 'Voted', 'Approved', 'Disapproved', 'Executed', 'MemberExecuted', 'Closed'];
        ...
        ConvictionVoting: ['Delegated', 'Undelegated', 'Voted', 'VoteRemoved'];
        ...
        Omnipool: ['TokenAdded', 'TokenRemoved', 'LiquidityAdded', 'LiquidityRemoved', 'ProtocolLiquidityRemoved', 'SellExecuted', 'BuyExecuted', 'PositionCreated', 'PositionDestroyed', 'PositionUpdated', 'TradableStateUpdated', 'AssetRefunded', 'AssetWeightCapUpdated'];
        ...
        CircuitBreaker: ['TradeVolumeLimitChanged', 'AddLiquidityLimitChanged', 'RemoveLiquidityLimitChanged', 'AssetLockdown', 'AssetLockdownRemoved', 'DepositReleased'];
        ...
        Ethereum: ['Executed'];
        EVMAccounts: ['Bound', 'DeployerAdded', 'DeployerRemoved', 'ContractApproved', 'ContractDisapproved'];
        ...
        PolkadotXcm: ['Attempted', 'Sent', 'UnexpectedResponse', 'ResponseReady', 'Notified', 'NotifyOverweight', 'NotifyDispatchError', 'NotifyDecodeFailed', 'InvalidResponder', 'InvalidResponderVersion', 'ResponseTaken', 'AssetsTrapped', 'VersionChangeNotified', 'SupportedVersionChanged', 'NotifyTargetSendFail', 'NotifyTargetMigrationFail', 'InvalidQuerierVersion', 'InvalidQuerier', 'VersionNotifyStarted', 'VersionNotifyRequested', 'VersionNotifyUnrequested', 'FeesPaid', 'AssetsClaimed', 'VersionMigrationFinished'];
        ...
        Session: ['NewSession'];
        EmaOracle: ['AddedToWhitelist', 'RemovedFromWhitelist'];
        Broadcast: ['Swapped3'];
    };
    errors: {
        ...
        MultiTransactionPayment: ['UnsupportedCurrency', 'ZeroBalance', 'AlreadyAccepted', 'CoreAssetNotAllowed', 'ZeroPrice', 'FallbackPriceNotFound', 'Overflow', 'EvmAccountNotAllowed', 'EvmPermitExpired', 'EvmPermitInvalid', 'EvmPermitCallExecutionError', 'EvmPermitRunnerError'];
        ...
        TechnicalCommittee: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength', 'PrimeAccountNotMember'];
        ...
        Dispatcher: ['EvmCallFailed', 'NotEvmCall'];
        ...
        Duster: ['AccountBlacklisted', 'AccountNotBlacklisted', 'ZeroBalance', 'BalanceSufficient', 'DustAccountNotSet', 'ReserveAccountNotSet'];
        ...
        OmnipoolLiquidityMining: ['AssetNotFound', 'Forbidden', 'ZeroClaimedRewards', 'InconsistentState', 'OracleNotAvailable', 'PriceAdjustmentNotAvailable', 'NoFarmEntriesSpecified'];
        ...
        CircuitBreaker: ['InvalidLimitValue', 'LiquidityLimitNotStoredForAsset', 'TokenOutflowLimitReached', 'TokenInfluxLimitReached', 'MaxLiquidityLimitPerBlockReached', 'NotAllowed', 'AssetInLockdown', 'AssetNotInLockdown', 'InvalidAmount'];
        ...
        XYK: ['CannotCreatePoolWithSameAssets', 'InsufficientLiquidity', 'InsufficientTradingAmount', 'ZeroLiquidity', 'ZeroInitialPrice', 'CreatePoolAssetAmountInvalid', 'InvalidMintedLiquidity', 'InvalidLiquidityAmount', 'AssetAmountExceededLimit', 'AssetAmountNotReachedLimit', 'InsufficientAssetBalance', 'InsufficientPoolAssetBalance', 'InsufficientNativeCurrencyBalance', 'TokenPoolNotFound', 'TokenPoolAlreadyExists', 'AddAssetAmountInvalid', 'RemoveAssetAmountInvalid', 'SellAssetAmountInvalid', 'BuyAssetAmountInvalid', 'FeeAmountInvalid', 'CannotApplyDiscount', 'MaxOutRatioExceeded', 'MaxInRatioExceeded', 'Overflow', 'CannotCreatePool', 'SlippageLimit'];
        ...
        EVM: ['BalanceLow', 'FeeOverflow', 'PaymentOverflow', 'WithdrawFailed', 'GasPriceTooLow', 'InvalidNonce', 'GasLimitTooLow', 'GasLimitTooHigh', 'InvalidChainId', 'InvalidSignature', 'Reentrancy', 'TransactionMustComeFromEOA', 'Undefined'];
        Ethereum: ['InvalidSignature', 'PreLogExists'];
        EVMAccounts: ['TruncatedAccountAlreadyUsed', 'AddressAlreadyBound', 'BoundAddressCannotBeUsed', 'AddressNotWhitelisted'];
        ...
        ParachainSystem: ['OverlappingUpgrades', 'ProhibitedByPolkadot', 'TooBig', 'ValidationDataNotAvailable', 'HostConfigurationNotAvailable', 'NotScheduled', 'NothingAuthorized', 'Unauthorized'];
    ...
    constants: {
        ...
        Duster: ['Reward', 'NativeCurrencyId', 'TreasuryAccountId'];
        ...
        HSM: ['HollarId', 'PalletId', 'GasLimit'];
    ...
    apis: {
        ...
        CurrenciesApi: ['account', 'accounts', 'free_balance'];
