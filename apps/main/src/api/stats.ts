...
const STATS_SQUID_URL = "https://galacticcouncil.squids.live/hydration-pools:orca-prod/api/graphql"
...
const fetchStatsGraphQL = async <T>(query: string, variables?: Record<string, unknown>): Promise<T> => {
