import { Modal, ModalHeader, ModalBody, Icon, Text } from "@galacticcouncil/ui/components"
                    ...
                    <ModalBody>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                            <SOptionCard onClick={() => handleAction("cex-deposit")}>
                                <div>
                                    <Text fw={600} style={{ marginBottom: 4 }}>Deposit from Centralized Exchange</Text>
                                    <Text fs={12} color="neutral.gray.400">Transfer assets from exchanges like Kraken, Binance, etc.</Text>
                                </div>
                            ...
                            <SOptionCard onClick={() => handleAction("on-chain")}>
                                <div>
                                    <Text fw={600} style={{ marginBottom: 4 }}>On-chain transfer</Text>
                                    <Text fs={12} color="neutral.gray.400">Bridge assets from other chains</Text>
                                </div>
                                <Icon component={ArrowRight} size={20} color="rgba(255,255,255,0.5)" />
                            </SOptionCard>
                            ...
                            <SOptionCard onClick={() => handleAction("crypto")}>
                                <div>
                                    <Text fw={600} style={{ marginBottom: 4 }}>Fund with crypto</Text>
                                    <Text fs={12} color="neutral.gray.400">Use existing crypto to fund your account</Text>
                                </div>
                                <Icon component={ArrowRight} size={20} color="rgba(255,255,255,0.5)" />
                            </SOptionCard>
                        </div>
