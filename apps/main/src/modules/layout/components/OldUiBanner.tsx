...
export const OldUiBanner: FC<{ onOpenMarketing: () => void }> = ({ onOpenMarketing }) => {
  ...
  return (
    <SBanner>
      ...
      >
        Check new UI switch in bottom right corner and share your thoughts on Discord.
      </Text>
      <SLink as="button" onClick={onOpenMarketing} style={{ background: 'none', border: 'none', borderBottom: '1px solid #1A1D26', padding: 0, cursor: 'pointer', fontFamily: 'inherit' }}>
        GO to Discord &gt;
      </SLink>
    </SBanner>
  )
