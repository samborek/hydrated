...
import { AssetInput, HealthFactorChange, HealthFactorRiskWarning, } from "@/components/primitives";
...
(function (ErrorType) {
    ErrorType[ErrorType["STABLE_RATE_NOT_ENABLED"] = 0] = "STABLE_RATE_NOT_ENABLED";
    ErrorType[ErrorType["NOT_ENOUGH_LIQUIDITY"] = 1] = "NOT_ENOUGH_LIQUIDITY";
    ErrorType[ErrorType["BORROWING_NOT_AVAILABLE"] = 2] = "BORROWING_NOT_AVAILABLE";
    ErrorType[ErrorType["NOT_ENOUGH_BORROWED"] = 3] = "NOT_ENOUGH_BORROWED";
})(ErrorType || (ErrorType = {}));
export const GhoBorrowModalContent = ({ poolReserve, symbol, }) => {
    ...
    maxAmountToBorrow = Math.min(Number(maxAmountToBorrow), ghoReserveData.aaveFacilitatorRemainingCapacity).toFixed(10);
    ...
    return (_jsxs(_Fragment, { children: [_jsx(AssetInput, { name: "borrow-amount", value: amount, onChange: handleChange, usdValue: usdValue.toString(10), assets: [
                    {
