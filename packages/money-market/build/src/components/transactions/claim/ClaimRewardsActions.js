...
export const ClaimRewardsActions = ({ blocked, selectedReward, }) => {
    ...
    return (_jsx(TxActionsWrapper, { requiresApproval: requiresApproval, blocked: blocked, preparingTransactions: loadingTxns, mainTxState: mainTxState, handleAction: action, actionText: selectedReward.symbol === "all"
            ? "Claim all"
            : `Claim ${selectedReward.symbol}`, actionInProgressText: "Claiming" }));
};
