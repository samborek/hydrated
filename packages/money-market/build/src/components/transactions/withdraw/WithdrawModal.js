...
export const WithdrawModal = () => {
    ...
    return (_jsx(BasicModal, { open: type === ModalType.Withdraw, setOpen: close, title: "Withdraw", children: _jsx(TxModalWrapper, { underlyingAsset: args.underlyingAsset, requiredPermission: PERMISSION.DEPOSITOR, children: (params) => _jsx(WithdrawModalContent, { ...params }) }) }));
};
