...
export const calculateMaxWithdrawAmount = (user, userReserve, poolReserve) => {
    ...
    if (userReserve?.usageAsCollateralEnabledOnUser &&
        ...
        maxAmountToWithdraw = Big.min(maxAmountToWithdraw, maxCollateralToWithdrawInETH.div(poolReserve.formattedPriceInMarketReferenceCurrency));
    }
