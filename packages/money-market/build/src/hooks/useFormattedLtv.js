...
export const useFormattedLtv = (loanToValue, currentLoanToValue, currentLiquidationThreshold) => {
    const { getToken } = useTheme();
    let ltvColor = getToken("accents.success.emphasis");
    ...
    else if (ltvPercent > currentLtvPercent / 2 &&
