...
export interface TransactionsSlice {
    ...
    addTransaction: (txHash: string, transaction: TransactionDetails, context?: TransactionContext) => void;
}
export declare const createTransactionsSlice: StateCreator<RootStore, [
