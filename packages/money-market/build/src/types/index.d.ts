...
export type MoneyMarketTxFn = (data: {
    tx: ExtendedEvmCall;
    toasts?: ToastsConfig;
}, options: {
    onSuccess: () => void;
...
export type FormatterFn = (value: number | bigint | string | null | undefined, opts?: Record<string, number | string>) => string;
export type ReserveFormatterFn = <T extends ReserveDataHumanized>(reserve: T) => T;
export type ExternalApyData = Map<string, {
    borrowApy: string;
    supplyApy: string;
}>;
