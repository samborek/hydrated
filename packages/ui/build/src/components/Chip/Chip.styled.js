...
const variants = createVariants(({ buttons, accents }) => ({
    primary: variantStyles(buttons.primary.high.onButton, buttons.primary.high.rest),
    secondary: variantStyles(buttons.primary.medium.onButton, buttons.primary.medium.rest),
    tertiary: variantStyles(buttons.primary.low.onButton, buttons.primary.low.rest),
