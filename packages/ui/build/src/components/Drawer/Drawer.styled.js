...
export const SDrawerContent = styled(Content) `
  ...
  border-top-left-radius: ${({ theme }) => theme.containers.cornerRadius.containersPrimary}px;
  border-top-right-radius: ${({ theme }) => theme.containers.cornerRadius.containersPrimary}px;
