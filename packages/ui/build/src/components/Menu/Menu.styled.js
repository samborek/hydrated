...
const menuItemVariants = createVariants((theme) => ({
    default: css `
    & ${MenuItemIcon} {
...
export const MenuItem = styled(Box)(({ theme, variant = "default" }) => [
    css `
      display: grid;
...
export const MenuItemIcon = styled(Icon) `
  ...
  height: 20px;
`;
export const MenuItemLabel = styled.span(({ theme }) => css `
    grid-row: 1;
    grid-column: 2;
    ...
    text-align: center;
  `);
export const MenuItemDescription = styled.span(({ theme }) => css `
    grid-row-start: 2;
    grid-column: 2;
...
export const MenuItemAction = styled.div `
  ...
  grid-column: 3;
`;
export const MenuSelectionItem = styled(MenuItem)(({ theme, variant = "default" }) => [
    css `
...
export const MenuSelectionItemArrow = styled(ArrowRight)(({ theme }) => css `
