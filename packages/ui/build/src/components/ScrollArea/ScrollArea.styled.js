...
`;
export const SScrollbar = styled(ScrollAreaPrimitive.ScrollAreaScrollbar)(({ theme }) => css `
    display: flex;
    touch-action: none;
    user-select: none;
  ...
  `);
export const SThumb = styled(ScrollAreaPrimitive.ScrollAreaThumb)(({ theme }) => css `
