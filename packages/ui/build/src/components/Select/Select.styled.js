...
export const SelectTrigger = styled(Trigger)(({ theme }) => css `
  ...
  `);
export const SContent = styled(Content)(({ theme }) => css `
    border-radius: 12px;
  ...
  `);
export const SItem = styled(Item)(({ theme }) => css `
    all: unset;
  ...
  `);
export const SViewport = styled(Viewport)(({ theme }) => css `
    display: flex;
