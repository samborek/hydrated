...
`;
export const SRange = styled.div(({ theme }) => css `
    position: absolute;
    height: 100%;
  ...
  `);
export const STrack = styled(Track)(({ theme }) => css `
    position: relative;
    height: 4px;
    ...
    border-radius: ${theme.radii.full}px;
  `);
export const SThumb = styled(Thumb)(({ theme }) => css `
    all: unset;
    display: flex;
    align-items: center;
  ...
  `);
export const SDash = styled.div(({ theme, row, offset }) => css `
    position: absolute;
