...
export const SStepContainer = styled(Box) `
  ...
  gap: 4px;
`;
export const SStepLabel = styled(Text)(({ theme }) => css `
  ...
  `);
export const SDesktopContainer = styled(Box)(({ maxWidth }) => css `
    flex-direction: row;
    align-items: center;
  ...
  `);
export const SCircle = styled(Box)(({ theme, state }) => css `
    width: 24px;
    height: 24px;
    ...
    : theme.buttons.primary.medium.rest};
  `);
export const SStepperLine = styled(Box)(({ theme }) => css `
    height: 1px;
    flex-grow: 1;
