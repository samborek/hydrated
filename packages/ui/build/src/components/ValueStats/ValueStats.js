...
export const ValueStats = ({ font = "primary", wrap, size, label, customLabel, value, customValue, bottomLabel, customBottomLabel, isLoading, className, ...props }) => {
    ...
    return (_jsxs(SValueStats, { shouldWrap: shouldWrap, size: size, className: className, ...props, children: [customLabel ?? _jsx(SValueStatsLabel, { children: label }), _jsxs(SValueStatsValueContainer, { size: size, children: [isLoading ? (_jsx(SValueStatsValue, { font: font, size: size, children: _jsx(Skeleton, { width: 120, height: "100%" }) })) : ((customValue ?? (_jsx(SValueStatsValue, { font: font, size: size, children: value })))), isLoading && (bottomLabel || customBottomLabel) ? (_jsx(SValueStatsBottomValue, { children: _jsx(Skeleton, { width: 120, height: "100%" }) })) : ((customBottomLabel ?? (bottomLabel ? _jsx(SValueStatsBottomValue, { children: bottomLabel }) : null)))] })] }));
};
