...
export const SValueStats = styled.div(({ size = "large", shouldWrap }) => [
    shouldWrap
        ? css `
        display: flex;
        flex-direction: column;
...
export const SValueStatsLabel = styled.div(({ theme }) => css `
  ...
  `);
const valueSizeVariants = createVariants((theme) => ({
    small: css `
...
export const SValueStatsValue = styled.div(({ theme, size = "large", font = "primary" }) => [
    css `
