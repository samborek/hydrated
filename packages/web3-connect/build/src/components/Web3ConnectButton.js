...
import { AccountAvatar, Button, Flex, Icon, Text, } from "@galacticcouncil/ui/components";
...
export const Web3ConnectButton = ({ ref, allowIncompatibleAccounts = false, ...props }) => {
    ...
    if (account) {
        ...
        return (_jsxs(SConnectedButton, { ref: ref, onClick: () => toggle(), ...props, variant: "tertiary", sx: { px: 10, gap: 8 }, children: [_jsx(AccountAvatar, { size: 24, address: account.displayAddress, theme: getAccountAvatarTheme(account) }), _jsxs(Flex, { direction: "column", children: [_jsx(Text, { fs: "p3", lh: 1.2, truncate: 140, children: account.name }), !stringEquals(account.name, shortDisplayAddr) && (_jsx(Text, { fs: "p6", color: getToken("text.medium"), children: shortDisplayAddr }))] }), _jsx(Icon, { size: 8, component: CaretDown })] }));
    }
